...
export default function ApproveFold() {
  ...
  let ONE_DECIMAL_FOLD_BAL =
    Math.floor(parseFloat(FoldBal?.formatted) * 10) / 10;
  let TWO_DECIMAL_FOLD_BAL =
    Math.floor(parseFloat(FoldBal?.formatted) * 100) / 100;
    ...
    <>
        ...
        <div className="p-2 mb-1 flex justify-between px-1.5">
          ...
          {isHydrated && (
            ...
            <button
              ...
              onClick={() =>
                ONE_DECIMAL_FOLD_BAL >= 100
                  ? setUserInput(ONE_DECIMAL_FOLD_BAL.toString())
                  : setUserInput(TWO_DECIMAL_FOLD_BAL.toString())
              }
            >
              (Max)
            </button>
      ...
      <div className="flex justify-center pt-4">
        <button
          ...
          disabled={isLoadingApprove || parseFloat(UserInput) < 0.01}
          onClick={() => {
