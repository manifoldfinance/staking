...
import AddTokensToMetaMask from './navigation/addTokensToMetamask';
import NetworkIndicator from './navigation/network';
import dynamic from 'next/dynamic';
import { Account } from './navigation/web3';
...
const WalletModal = dynamic(() => import('./navigation/walletModal'), {
  ssr: false,
});
      ...
      <ul className="flex justify-between items-center">
        <li className="flex-shrink-0">
          <div className="flex items-center">
            ...
            <Link href="https://staking.manifoldfinance.com">
              <a
        ...
        <li className="hidden flex-1 xl:block">
          <ul className="flex space-x-2 md:ml-4 xl:space-x-4">
            ...
            <li>
              <NavigationItem href="/stake" text="Portal" />
            </li>
            <li>
              <NavigationItem
            ...
            <li>
              <NavigationItem
                href="https://github.com/manifoldfinance/staking"
                text="GitHub"
              />
            </li>
            <li>
