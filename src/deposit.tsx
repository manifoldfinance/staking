import Button, { BuyLink, MaxButton } from './shared/button';
import {
  MAX_FOLD_MINTABLE,
  MIN_INPUT_VALUE,
  MaxUint256,
} from '@/constants/numbers';
import TokenSelect, { Token } from './shared/tokenSelect';
...
import { useOperatorAddress } from './shared/useContract';
  ...
  return (
    <form className="space-y-4" onSubmit={tokenDeposit}>
      <div className="flex justify-between">
        <h2 className="font-medium leading-5">Operator</h2>
      ...
      <div className="space-y-4">
        ...
        <Button
          type="submit"
          disabled={
            !(mintInput.hasValue && !!mintToken) || mintTokenNeedsApproval
          }
        >
