...
export interface FOLDInterface extends utils.Interface {
  functions: {
    ...
    'getInitData(string,string,address,uint256)': FunctionFragment;
...
export interface FOLD extends BaseContract {
  [x: string]: any;
